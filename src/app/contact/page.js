...
export const metadata = {
  title: "Contact HouseCall MD - Get in Touch | Los Angeles",
  description: "Contact HouseCall MD for mobile healthcare services in Los Angeles. Call 626-765-4321 or visit us at 1494 S. Robertson Blvd, Suite 200. 24/7 availability for urgent care needs.",
  keywords: ["contact HouseCall MD", "mobile doctor contact", "Los Angeles healthcare contact", "house call doctor phone", "medical appointment booking"],
  openGraph: {
    title: "Contact HouseCall MD - Get in Touch | Los Angeles",
    description: "Contact HouseCall MD for mobile healthcare services in Los Angeles. Call 626-765-4321 or visit us at 1494 S. Robertson Blvd, Suite 200. 24/7 availability for urgent care needs.",
    url: "https://housecallmd.com/contact",
  },
};
...
export default function Contact() {
  ...
  const localBusinessSchema = {
    ...
    "priceRange": "$$",
    "paymentAccepted": ["Cash", "Credit Card", "Check", "Medicare", "Private Insurance"],
    ...
    "hasOfferCatalog": {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "itemOffered": {
            "@type": "Service",
            "name": "Post Discharge Management"
          }
        },
        {
          "@type": "Offer",
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 hover:shadow-xl transition-shadow duration-300">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-700 text-xs sm:text-sm">info@admin.local</p>
                </div>
              </div>
