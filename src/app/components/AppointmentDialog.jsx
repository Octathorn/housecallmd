...
const AppointmentDialog = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center animate-in fade-in duration-300">
      ...
      {/* Dialog */}
      <div className="relative bg-green-600 rounded-lg p-6 sm:p-8 max-w-md w-full mx-4 shadow-2xl border-2 border-green-400 animate-in zoom-in-95 duration-300">
        {/* Close Button */}
        <button
          onClick={onClose}
